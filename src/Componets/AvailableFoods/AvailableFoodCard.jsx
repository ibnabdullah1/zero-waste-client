  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {Status === "available" ? (
          <h2 className=" absolute top-4 right-4 bg-green-500 px-4 py-[2px] font-semibold text-white rounded-2xl">
            {Status}
          </h2>
        ) : (
          <h2 className=" absolute top-4 right-4 bg-[#ffc933] px-4 py-[2px] font-semibold text-white rounded-2xl">
            {Status}
          </h2>
        )}
      </div>
